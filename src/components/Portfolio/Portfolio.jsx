...
const list = [
  ...
  //   image: centuryHome,
  //   tour: <iframe title="large" style={{maxWidth: '100%'}} width="640" height="480" frameBorder="0" allowFullScreen src="https://players.cupix.com/embed.html?key=CHHNXosn"></iframe>
  // },
  {
    name: 'Condo',
    image: condo,
